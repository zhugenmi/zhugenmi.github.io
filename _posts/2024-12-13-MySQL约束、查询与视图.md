...
- 建表时添加外键约束
  ...
  -- 添加订单数据
  INSERT INTO orderlist VALUES (NULL,'imti001',1),(NULL,'imti002',1),
  (NULL,'imti003',2),(NULL,'imti004',2),
  (NULL,'imti005',3),(NULL,'imti006',3);
  
  -- 添加一个订单，但是没有所属用户。这合理吗？
  INSERT INTO orderlist VALUES (NULL,'imti007',8);
...
-- 添加数据
INSERT INTO orderlist VALUES (NULL,'imti001',1),(NULL,'imti002',1),(NULL,'imti003',2),(NULL,'imti004',2);
...
-- 添加数据
INSERT INTO orderlist VALUES (1,'imti001',1);
INSERT INTO orderlist VALUES (2,'imti002',1);
INSERT INTO orderlist VALUES (3,'imti003',2);
INSERT INTO orderlist VALUES (4,'imti004',2);
INSERT INTO orderlist VALUES (5,'imti005',3);
INSERT INTO orderlist VALUES (6,'imti006',3);
INSERT INTO orderlist VALUES (7,'imti007',NULL);
...
- 备份
  ...
  - 开始-运行-cmd回车，输入：mysqldump -u root -p 数据库名称 > 文件保存路径

  ![](../assets/img/mysql/QQ图片20220731214214.png)

  - 进入文件保存路径，查看文件是否存在

  

  ![QQ截图20220731214311](../assets/img/mysql/QQ截图20220731214311.png)

- 恢复

  - 登录mysql数据库

  ![](../assets/img/mysql/QQ截图20220731214413.png)

  ![QQ截图20220731214504](../assets/img/mysql/QQ截图20220731214504.png)

  ![QQ截图20220731214529](../assets/img/mysql/QQ截图20220731214529.png)
...
![05](../assets/img/mysql/05.png)

![06](../assets/img/mysql/06.png)

![07](../assets/img/mysql/07.png)

- 恢复

![08](../assets/img/mysql/08.png)

![09](../assets/img/mysql/09.png)

![10](../assets/img/mysql/10.png)

![11](../assets/img/mysql/11.png)
